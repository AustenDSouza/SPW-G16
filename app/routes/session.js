    ...
    this.handleLoginRequest = (req, res, next) => {
        ...
        userDAO.validateLogin(userName, password, (err, user) => {
            ...
            /*
                ...
                The following constants are removed from usage to prevent insecure error messages:
            ...
            */
            if (err) {
                if (err.noSuchUser) {
                    ...
                    /*
                        This code is changed to prevent Log injection/Log forging
                    ...
                    */
                    ...
                    return res.render("login", {
                        ...
                        password: "",
                        /*
                            This error message is changed to a common error message
